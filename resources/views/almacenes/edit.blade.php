    ...
    <div class="contact__wrapper shadow-lg mt-n9">
      <div class="row no-gutters">
        <div class="col-lg-12 contact-form__wrapper p-5 order-lg-1">
          <form action="{{route('almacenes.update', $almacene->id)}}" class="contact-form form-validate" method="POST"
              ...
              <div class="col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre"
                         value="{{$almacene->nombre}}" required>
                </div>
              ...
              <div class="col-sm-6 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="ubicacion" name="ubicacion" placeholder="Ubicación"
                         value="{{$almacene->ubicacion}}" required>
                </div>
