    ...
    <div class="contact__wrapper shadow-lg mt-n9">
      <div class="row no-gutters">
        <div class="col-lg-12 contact-form__wrapper p-5 order-lg-1">
          <form action="{{route('productos.update', $producto->id)}}" class="contact-form form-validate" method="POST" enctype="multipart/form-data">
            @method("put")
            @csrf
            <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                ...
                <div class="invalid-feedback @error('almacenes') d-block @enderror">
              ...
              <div class="col-sm-12 mb-3">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="observaciones" name="observaciones" rows="4"
                            placeholder="Observaciones">{{$producto->observaciones}}
                  </textarea>
                </div>
              </div>
              <div class="col-sm-12 mb-3">
